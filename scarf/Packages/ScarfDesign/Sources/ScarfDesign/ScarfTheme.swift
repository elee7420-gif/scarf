...
public enum ScarfGradient {
    ...
    public static let brand = LinearGradient(
        colors: [
            Color(red: 0.929, green: 0.749, blue: 0.302), // #EDBF4D
            Color(red: 0.804, green: 0.518, blue: 0.125), // #CD8420
            Color(red: 0.753, green: 0.455, blue: 0.031)  // #C07408
        ],
    ...
    public static let brandSoft = LinearGradient(
        colors: [
            Color(red: 1.000, green: 0.831, blue: 0.518), // #FFD484
            Color(red: 0.894, green: 0.631, blue: 0.141)  // #E4A124
        ],
        startPoint: .topLeading,
        endPoint:   .bottomTrailing
    )
